	...
	<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl  mx-6 lg:mx-0 bg-gray-100">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<p class="pt-8 text-black">
				Hi, as you can tell i am a font developper. i have just finished my first year as un Epitech student. i am currentry looking for un intern to gain profetion expirience
			</p>
			...
			<CopyToClipboard text="https://github.com/rukundoronaldo">
				...
				<a class="link" href="" data-tippy-content="@youtube_handle"><img class="h-6 fill-current text-gray-600 hover:text-green-700" src={linkd} /></a>
				</CopyToClipboard>
			</div>
